<x-admin-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Admin Dashboard') }} - {{ __('Edit menu') }}: {{ $menu->name }}
        </h2>
    </x-slot>
                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="POST" action="{{ route('admin.menus.update', $menu) }}" enctype="multipart/form-data">
                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div>
                                <img src="{{ $menu->image ? Storage::url($menu->image) : asset('images/menus/menu-default.jpg') }}" class="w-32 h-32 rounded">
                            </div>
                            <div class="mt-1">
                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div class="mt-1">
                                <input type="number" min="0.00" max="10000.00" step="0.01" id="price" name="price"  value="{{ old('price', $menu->price) }}"
                                    class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5
                        ...
                        <div class="sm:col-span-6 pt-5">
                            ...
                            <div class="mt-1">
                                <select id="categories" name="categories[]" class="form-multiselect block w-full mt-1 rounded-md @error('categories') border-red-400 @enderror"
                                    multiple>
